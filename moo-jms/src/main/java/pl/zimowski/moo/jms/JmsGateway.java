...
public class JmsGateway {
     ...
     * An example of a private event action is request to generate random
     * nick name. A public event is one that server broadcasts to all other
     * clients over {@link #TOPIC_SERVER_EVENTS}. Example of public event action
     * is the actual chat message.
     */
